...
Node.prototype.update = function() {
	...
	if (this.scenario === 1) { 
		...
		/*var dX = 170 - this.x; // Get the body position in units from the screen center X
		var dY = 140 - this.y; // Get the body position in units from the screen center Y
		...
		var accel = Math.max( 0, (distance - 20) / 100);
